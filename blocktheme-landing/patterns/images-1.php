...
/**
 * Title: images 1
 * Slug: blocktheme/images-1
 */
?>
<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"x-large"} -->
<p class="has-x-large-font-size">Certificates</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full"><img src="<?=get_template_directory_uri()?>/images/placeholder.png" alt="" style="aspect-ratio:3/4;object-fit:cover"/></figure>
<!-- /wp:image -->
